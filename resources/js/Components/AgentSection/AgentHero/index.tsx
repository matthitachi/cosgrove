    ...
    return (
        <>
            ...
            <ol>
                ...
                <li><b>TIME TABLE: </b>Cosgrove will assure you get all Marketing Tools/Essentials. E.g. (Newsletters and Brochure).</li>
                <li>
                    <b>MARKETING/ MANAGEMENT FEE: </b>We are not under any obligation to pay <b>THE AGENT</b> Marketing / Managerial fee. Cosgrove is responsible for managing its own organization. Cosgrove shall pay a <b>5%</b> commission to <b>THE AGENT</b> for every sale and this should cover the marketing fee (5% commission) which will be paid on every installment received by Cosgrove.
...
interface Props {
    ...
    formSection?: ApiPageSection;
}

export default function ({ cmsSection, formSection }: Props) {
            ...
            <Container fluid>
                <Row>
                    ...
                    <Col md={12} lg={7} className={styles.infoHomeInfo}>
                        {(formSection?.data?.intro_text as string)
                            ? <div dangerouslySetInnerHTML={{ __html: formSection!.data!.intro_text as string }} />
                            : <AgentTermsFallback />
                        }
                    </Col>
