...
export default function ({height, bgImage}: headerItemProp) {
    ...
    const listenScrollEvent = ()=>{
        ...
        if (window.scrollY <= bgHeight) {
            setResponsiveCurveValue(curveValue *  (1 - (window.scrollY/bgHeight )))
        }
    };
    useEffect(()=>{
    ...
    return (
      <section className={styles.headerItem} style={{height: `${height}vh`}}>
          <div className={`curvedBottom ${styles.headerBgItem}`}
               style={{
