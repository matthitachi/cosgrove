...
function TermsBodyFallback() {
    return (
        <>
            ...
            <p className="textPrimary">
                Cosgrove Investment LTD is a pioneering real estate developer that integrates technology and sustainability into residential and commercial properties. Our portfolio features high-value properties designed to appreciate over time; located in Nigeria.
            </p>
            ...
            <p className="textPrimary">
                These Terms of Service shall be governed by and construed in accordance with the laws of The Federal Republic of Nigeria, without regard to its conflict of law principles.
            </p>
...
export default function () {
    ...
    const bodyHtml = textSection?.data?.body as string | undefined;
    ...
    return (
        <div>
            ...
            <Container>
                <div>
                    <h5 className={'subHeader  mt-5 mb-2'}>{(textSection?.data?.label as string) ?? 'Terms of Service'}</h5>
