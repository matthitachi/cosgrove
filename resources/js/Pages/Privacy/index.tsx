...
function PrivacyBodyFallback() {
    return (
        <>
            ...
            <p className="textPrimary">We collect both personal and non-personal information, which may include but is not limited to:</p>
            ...
            <p className="textPrimary">We reserve the right to update and modify this Privacy Policy at any time.</p>
...
export default function () {
    ...
    return (
        <div>
            ...
            <Container>
                <div>
                    <h5 className={'subHeader  mt-5 mb-2'}>{(textSection?.data?.label as string) ?? 'Privacy Policy'}</h5>
